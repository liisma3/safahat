...
const EnhancedTableHead: React.FC<EnhancedTableHeadPropsType> = (props: EnhancedTableHeadPropsType) => {
      ...
      <div>
        {numSelected > 0 ? (
          ...
          <Tooltip title="Filter list">
            <IconButton aria-label="Filter list" size="medium">
              <FilterListIcon />
            </IconButton>
          </Tooltip>
        )}
                ...
                .map((row: RowType, index: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                        {row.status === 0 && <Chip size="small" label="Shipped" shipped />}
                        {row.status === 1 && <Chip size="small" label="Processing" processing />}
                        {row.status === 2 && <Chip size="small" label="Cancelled" cancelled />}
                      </TableCell>
