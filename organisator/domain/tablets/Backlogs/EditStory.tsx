...
// types
import { TabletColumn, TabletProfile, TabletUserStory } from '@/components/shared/types/tablet';

interface Props {
  story: TabletUserStory;
  open: boolean;
...
// ==============================|| Tablet BACKLOGS - EDIT STORY ||============================== //

const EditStory = ({ story, open, handleDrawerOpen }: Props) => {

  const { state: { cards, columns } } = useTablet();
                          ...
                          <Grid container alignItems="center" spacing={2}>
                            ...
                            <Grid item xs={12} sm={8}>
                              <Grid container justifyContent="flex-start">
                                {/*  <Autocomplete
                                  id="assign"
                                  /*  value={cards.find((profile: TabletProfile) => profile.id === formik.values.assign) || null}
                ...
                <Grid item xs={12}>
                  {/*  {story?.commentIds &&
                    [...story?.commentIds].reverse().map((commentId, index) => {
                      ...
                      const profile = cards.filter((item) => item.id === commentData.profileId)[0];
