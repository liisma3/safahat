...
// types
import { TabletItem, TabletProfile, TabletUserStory, TabletColumn } from '@/components/shared/types/tablet';
...
// ==============================|| Tablet BOARD - ITEM EDIT ||============================== //

const EditItem = ({ item, viewers, userStory, columns, handleDrawerOpen }: Props) => {

  const { state: { cards } } = useTablet()
            ...
            <Grid container alignItems="center" spacing={2}>
              ...
              <Grid item xs={12} sm={8}>
                <Grid container justifyContent="flex-start">
                  <Autocomplete
                    id="assign"
                    value={viewers.find((profile: string) => viewer === formik.values.assign)}
            ...
            <Grid container alignItems="center" spacing={2}>
              ...
              <Grid item xs={12} sm={8}>
                <FormControl fullWidth>
                  ...
                  >
                    {userStory.map((story: TabletUserStory, index: number) => (
              ...
              <Grid item xs={12} sm={8}>
                <FormControl fullWidth>
                  <Select
                    ...
                    inputProps={{ 'aria-label': 'Without label' }}
                  >
                    {columns.map((column: TabletColumn, index: number) => (
